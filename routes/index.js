...
var connection = mysql.createPool({
  ...
  user            : 'b5e106f439d40a',
  password        : 'cd5c3d3d',
  database        : 'heroku_f611e3e240d3aa4'
});
...
router.get('/picks', async function(req, res, next) {
  var d = new Date();
  var day = d.getDate();
  var month = d.getMonth() + 1;
  var year = d.getFullYear();
  var prettyDate = year + '-' + month + '-' + day;
  var tempDate = '2017-12-25';
  var query = "select * from games where date = '" + tempDate + "';"
